...
2. Implement the change. Run the repo's tests / linters / formatters and fix what they catch (only if they catch something in your changed area — don't fix unrelated pre-existing failures).
...
3. Run the repo's tests / linters / formatters and fix what they catch in your changed area.
